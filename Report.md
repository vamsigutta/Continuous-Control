...
### Model Architecture
The DDPG algorithms require two neural networks to run one computes the value which is the Actor NN and other computes the policy which is the Critic NN. As you can the Below code represents the model of the both the Actor and Critics
